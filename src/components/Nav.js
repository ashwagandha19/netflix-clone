            ...
            <div className="nav__contents">
                ...
                <div className="left__container">
                    ...
                    <ul className="nav__items">
                        <li className="nav__item"><a href="home" className="nav__link">Homepage</a></li>
                        <li className="nav__item"><a href="re-watch" className="nav__link">Re-watch</a></li>
                        <li className="nav__item"><a href="series" className="nav__link">Series</a></li>
                        <li className="nav__item"><a href="films"className="nav__link">Films</a></li>
                        <li className="nav__item"><a href="new-and-popular" className="nav__link">New and popular</a></li>
                        <li className="nav__item"><a href="my-list" className="nav__link">My List</a></li>
                    </ul>
                </div>
